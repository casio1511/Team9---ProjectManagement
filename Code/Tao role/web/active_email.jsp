  ...
  <div class="container">
    <div class="header-top">
      ...
      <div class="login-bars">
        ...
        <%}else {response.sendRedirect("information.jsp");}%>
        <div class="cart box_1">
          <a href="checkout.jsp">
            <h3>
              <div class="total">
                <span>0 item(s)</span></div></h3>
          </a>
...
<div class="head-bread">
  <div class="container">
    <ol class="breadcrumb">
      ...
      <li class="active">Active Account</li>
    </ol>
  </div>
</div>
<!-- contact -->
<%
if(request.getParameter("active")!= null && Integer.parseInt(request.getParameter("active")) == 1 && request.getParameter("email")!= null) {
  String email = request.getParameter("email");
  AccountDAO.activeUser(email);
...
<div class="contact">
  <div class="container">
    <h3 align="center">Active Email</h3>
    <div align="center">
      <p>Please active your account by verifying your email address</p>
      <p><a href="#">Not received? Send mail again</a></p>
    </div>
  </div>
</div>
<%}%>
