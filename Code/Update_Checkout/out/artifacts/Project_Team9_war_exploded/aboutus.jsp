  ...
  <div class="container">
    ...
    <div>
      <table align="center" style="border-collapse: separate; border-spacing: 10px">
        ...
        <tr><td>8.</td><td> After login fail 3 times, you will be locked and can login again after 30 minutes</td></tr>
        <tr><td>9.</td><td> After register an account, you must wait for the administator active your account</td></tr>
        <tr><td>10.</td><td> You must login to comment</td></tr>
      </table>
    </div>
  </div>
</div>
