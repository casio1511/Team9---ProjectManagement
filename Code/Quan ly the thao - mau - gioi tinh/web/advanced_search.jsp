...
<form action="Search" method="post">
    <table width="600px;" border="1" cellpadding="5" cellspacing="0" bgcolor="#add8e6" bordercolor="#FFFFFF" align="center">
        ...
        <tr>
            ...
            <td height="50px;" align="left" style="color: red"><strong>From</strong><input style="height:30px; font-size:14px" type="text" name="fromprice"/><strong> to</strong><input style="height:30px; font-size:14px" type="text" name="toprice"/></td>
        </tr>
        ...
        <tr>
            <td height="50px;" align="center" bordercolor="#CCCCCC" colspan="2"><input type="submit" value="SEARCH"></td>
        </tr>
    </table>
</form>
