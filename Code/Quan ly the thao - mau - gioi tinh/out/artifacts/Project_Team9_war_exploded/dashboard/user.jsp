                ...
                <div class="table-responsive">
                  <form method="post" action="AddSize.jsp">
                    <table width="89%" class="table table-hover">
                      ...
                      <tr>
                        <td><%=account.getM_ID()%></td>
                        <td><%=account.getM_Name()%></td>
                        <td><%=account.getM_Date()%></td>
                        <td>
                          <%if(account.getM_Status()==0){%>
                            <a href="EditUser.jsp?action=active&&id=<%=account.getM_ID()%>" style="text-decoration: none"><span class="label label-warning">Inactive</span></a>
                          <%}else{%>
                            <a href="EditUser.jsp?action=inactive&&id=<%=account.getM_ID()%>" style="text-decoration: none"><span class="label label-success">Actived</span></a>
                          <%}%>
                        </td>
                      ...
                      <tr>
                        ...
                        <td><a href="user.jsp?page=2">Next</a></td>
                        <%}else if(page_number == page_total && total > 6){%>
                        <td><a href="user.jsp?page=<%=page_number-1%>">Prev</a></td>
                        <%} else if(total <= 6) {%>
                        <td></td>
                        <%}else{%>
                        <td>
                          <a href="user.jsp?page=<%=page_number-1%>">Prev</a>&nbsp;&nbsp;&nbsp;
                          <a href="user.jsp?page=<%=page_number+1%>">Next</a>
                        </td>
                        <%}%>
                      </tr>
                    </table>
