...
public class RoleJSPGUI {
    ...
    public static String ShowRole (){
        ...
        sb.append("<div class='work-progres'><div class='chit-chat-heading'>Role</div>" +
                ...
                " <td><b>Bill Role</b></td><td><b>Account Role</b></td><td></td></tr>");
                ...
                for (Role role : list_role){
                    if(role.getM_ID() != 0) {
                        ...
                        if (role.getM_Account() == 0)
                            sb.append("<td><input type='checkbox' name='account" + role.getM_ID() + "' style='border: none'></td>");
                        else
                            sb.append("<td><input type='checkbox' checked name='account" + role.getM_ID() + "' style='border: none'></td>");
