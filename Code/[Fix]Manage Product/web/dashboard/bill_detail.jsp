            ...
            <div class="appearance">
              <div class="col-md-6 col-lg-5">
                ...
                <table class="table table-bordered">
                  <thead>
                  <tr>
                    <th width="28%">Bill ID</th>
                    <th width="72%"><%=bill.getM_ID()%></th>
                  </tr>
                  </thead>
                  <tbody>
                  <tr>
                ...
                <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td>Total Bill</td>
                    <td><%=nf.format(bill.getM_Total())%> dong</td>
                  </tr>
                  </tbody>
                </table>
                ...
                <table class="table table-bordered">
                  ...
                  <tr>
                    <td>Phone</td>
                    <td><%=bill.getM_Phone()%></td>
                  </tr>
                  <tr>
                    <td>Address</td>
                    <td><%=bill.getM_Address()%></td>
                  </tr>
                  <tr>
                    <td>Email</td>
                    <td><%=bill.getM_Email()%></td>
                  </tr>
                  </tbody>
                </table>
