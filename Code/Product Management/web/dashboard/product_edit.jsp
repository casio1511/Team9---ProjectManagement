            ...
            <div class="appearance">
              ...
              <div class="col-md-6 col-lg-5">
                ...
                <table class="table table-bordered">
                  ...
                  <tr>
                    <td>Size</td>
                    <td><input type="number" min="5" name="size" value="<%=product.getM_Size()%>"></td>
                  </tr>
                  <tr>
                    <td>Quantity</td>
                    <td><input type='number' min='1' name="quantity" value="<%=product.getM_Quantity()%>"></td>
                  </tr>
                  <tr>
                    <td>Price</td>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="col-md-6">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      <td>Image</td>
                      <td><input type="file" id="image" name="image" onchange="ValidateFileUpload()"></td>
                    </tr>
                    </tbody>
                  </table>
