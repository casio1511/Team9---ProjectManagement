...
public class OrderController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int billid = 0;
        Bill bill = new Bill();
            userid= AccountDAO.getUser(username, password).getM_ID();
            for (Cart cart:list){
            ...
            if (err.length() == 0 ) {
                ...
                SendEmail.main(SendMailJSPGUI.Receipt(name, bill_new.getM_Date(), billid, bill_new.getM_Total(), address, list_pd), "hellenp1995@gmail.com");
                do {
