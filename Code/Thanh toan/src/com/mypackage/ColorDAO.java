...
public class ColorDAO {
    ...
    public static boolean Insert (Color color){
        boolean check=true;
        String database = "shoe_database";
        String connectionURL = "jdbc:mysql://localhost:3306/" + database;
        String dbUser = "root";
        ...
        try {
            conn = DriverManager.getConnection(connectionURL, dbUser, dbPassword);
            stmt = conn.prepareStatement("INSERT INTO color(Name) VALUES(?)");
            stmt.setString(1, color.getM_Name());
            stmt.executeUpdate();
            stmt.close();
            if (conn != null) {
                conn.close();
    ...
    public static boolean Delete (int id){
        ...
        try{
            ...
            stmt = connection.prepareStatement("delete from color where ID=?");
            stmt.setInt(1, id);
            stmt.executeUpdate();
            if(connection != null){
                connection.close();
