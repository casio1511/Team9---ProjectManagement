    ...
    public static String showGetAllPaging (List<Product> list){
        ...
        for(Product product : list){
            sb.append("<div class='col-md-4 grid-stn simpleCart_shelfItem'>" +
                    ...
                    "<p><a href='single.jsp?id="+product.getM_ID()+"' class='item_add'><span class='glyphicon glyphicon-shopping-cart grid-cart' aria-hidden='true'></span>" +
    ...
    public static String checkOut (List<Cart> cart){
        ...
        for(Cart item : cart){
            ...
            sb.append("<div class='cart-header'>" +
                    ...
                    "<li><p>Qty <input type='number' value='"+item.getM_quantity()+"' name='quantity"+item.getM_product().getM_ID()+"' width='50px' required></p>" +
