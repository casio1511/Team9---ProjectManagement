...
public class ProductDAO {
    ...
    public static List<Product> getAllPaging(int page, int row){
        ...
        try{
            connection = DriverManager.getConnection(connectionURL, dbUser, dbPassword);
            stmt = connection.prepareStatement("select DISTINCT * from product GROUP BY Name");
    ...
    public static List<Product> getAllSportPaging(int sport, int page, int row){
        ...
        try{
            connection = DriverManager.getConnection(connectionURL, dbUser, dbPassword);
            stmt = connection.prepareStatement("select DISTINCT * from product where sport=? GROUP BY Name");
            stmt.setInt(1, sport);
    ...
    public static boolean Edit (int ID, String Name, int Category, int Sport, int Gender, int Color,
                                int Size, int Quantity, double Price, int Status, String Image ){
        boolean check=true;
        String database = "shoe_database";
        String connectionURL = "jdbc:mysql://localhost:3306/" + database;
        String dbUser = "root";
    ...
    public static boolean Delete (String Name, int Color, int Gender, int Sport){
        ...
        try{
            connection = DriverManager.getConnection(connectionURL, dbUser, dbPassword);
            stmt = connection.prepareStatement("delete from product where Name=? and Color=? and Gende=? and Sport=?");
            stmt.setString(1, Name);
            stmt.setInt(2, Color);
