    ...
    <div class="reg">
      ...
      <form onsubmit='return CheckInput()' action="registercontroller" method="post">
        <ul>
          ...
          <li><input type="text" id="username" name="username" class="username"></li>
          <li><span class="checkusername" id="checkusername" style="color:red"></span></li>
        </ul>
        <ul>
          <li class="text-info">Password: </li>
          <li><input type="password" id="password" name="password" onchange="CheckPassword()"></li>
          <li><span id="checkpassword" style="color:red"></span></li>
        </ul>
        <ul>
          <li class="text-info">Re-enter Password:</li>
          <li><input type="password" id="repassword" name="repassword" onchange="CheckPassword()"></li>
          <li><span id="checkrepassword" style="color:red"></span></li>
        </ul>
        <ul>
          <li class="text-info">Full Name: </li>
          <li><input type="text" id="name" name="name" onchange="CheckName()"></li>
          <li><span class="checkname" id="checkname" style="color:red"></span></li>
        </ul>
        <ul>
          <li class="text-info">Email: </li>
          <li><input type="text" id="email" name="email" class="email"></li>
          <li><span class="checkemail" id="checkemail"></span></li>
        </ul>
        <ul>
          <li class="text-info">Address:</li>
          <li><input type="text" id="address" name="address" onchange="CheckAddress()"></li>
          <li><span id="checkaddress" style="color:red"></span></li>
        </ul>
        <ul>
          <li class="text-info">Mobile Number:</li>
          <li><input type="text" id="phone" name="phone" onchange="CheckPhone()"></li>
