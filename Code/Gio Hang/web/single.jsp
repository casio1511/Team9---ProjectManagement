  ...
  <div class="container">
    ...
    <div class="detai-tabs">
      ...
      <form method="post" action="CommentController">
        <input type="text" class="textbox" value=" Your Name" name="name" id="name" required><br>
        <input type="text" class="textbox" value="Your E-Mail" name="email" id="email" required><br>
        <div class="clear"> </div>
        <div>
