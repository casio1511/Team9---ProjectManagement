...
<div class="contact">
  <div class="container">
    <h3>Instruction of N-Air website</h3>
    <div>
      <table align="center" style="border-collapse: separate; border-spacing: 10px">
        <tr><td>1.</td><td> Index page shows 6 hottest products of the store</td></tr>
        <tr><td>2.</td><td> Product page shows all products of the store with paging</td></tr>
        <tr><td>3.</td><td> You can choose the category in the product page</td></tr>
        <tr><td>4.</td><td> You can choose the brand in the product page</td></tr>
        <tr><td>5.</td><td> You can choose the gender in the product page</td></tr>
        <tr><td>6.</td><td> You can choose the arragement in the product page</td></tr>
        <tr><td>7.</td><td> If you want to buy a product, you must login first</td></tr>
        <tr><td>8.</td><td> After login fail 3 times, you will be locked and can login again after 5 minutes</td></tr>
        <tr><td>9.</td><td> After register, you must active by your email</td></tr>
        <tr><td>10.</td><td> You must login before comment</td></tr>
        <tr><td>11.</td><td>You must login before add a product to cart</td></tr>
        <tr><td>12.</td><td>You cannot set the quantity in cart be a negative number or characters</td></tr>
      </table>
    </div>
  </div>
</div>
