...
<div class="check">
  <div class="container">
    ...
    <script>
      ...
      function CheckInput() {
        if(CheckPhone() == true && CheckName() ==true && CheckAddress() == true){
          return true;
        }
        else {
    ...
    <div class="col-md-9 cart-items">
      ...
      <div class="reg-form">
          <div class="reg">
            <form onsubmit='return CheckInput()' action="OrderController"  method="post">
              <ul>
              ...
              <ul>
                ...
                <input type="hidden" name="email" id="email" value="<%=account.getM_Email()%>">
              </ul>
