...
<div class="shop-grid">
  <div class="container">
    <%=ProductJSPGUI.showIndex(ProductDAO.getMostViewPaging(1,6))%>
    <div class="clearfix"></div>
  </div>
</div>
<div class="sub-news">
...
<div class="footer-grid">
  <div class="container">
    ...
    <div class="col-md-6 re-ft-grd">
      <h3>Social</h3>
      <ul class="social">
        <li><a href="https://www.facebook.com/groups/269939793349299/?fref=ts" class="fb" target="_blank">facebook</a></li>
        <li></li>
        <li></li>
        <div class="clearfix"></div>
      </ul>
