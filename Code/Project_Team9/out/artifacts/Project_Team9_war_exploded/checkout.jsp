    ...
    <div class="col-md-3 cart-total">
      ...
      <div class="price-details">
        ...
        <%
          ...
          if(session.getAttribute("username")!=null && session.getAttribute("cart") == null && session.getAttribute("total") == null)
            response.sendRedirect("product.jsp");
          else if(session.getAttribute("cart") != null)
            cart = (ArrayList<Cart>)session.getAttribute("cart");
          for(Cart item: cart){
            total_price = total_price + item.getM_product().getM_Price() * item.getM_quantity();
          }
          if(session.getAttribute("total") != null)
